		...
		<div class="rows_wrap clearfix custom_name">
	        <div class="rows_content">
	            <div v-class="tip:true,												
	                ...
	                <span v-show="validation.sarea.numeric&&validation.sarea.dirty">面积只能为数字</span>
	                <span v-show="validation.sarea.min&&validation.sarea.dirty">面积不能小于1</span>
	                <span v-show="validation.sarea.max&&validation.sarea.dirty">面积不能大于10000</span>
	            </div>
	            ...
	            <div v-class="input_text_wrap:true, clearfix:true, error:validation.sarea.invalid&&validation.sarea.dirty,success:validation.sarea.valid" style="position: relative;">
	                <span>共</span><input type="inputText" style="width: 95px;" v-model="sarea" v-validate="required,numeric,min:1,max:10000"><span>㎡</span>
	            </div>
	        </div>
	    ...
	    <div class="rows_wrap clearfix custom_name">
	        <div class="rows_content">
	            <div v-class="tip:true,												
	                ...
	                <span v-show="validation.sprice.numeric&&validation.sprice.dirty">租金只能为数字</span>
	                <span v-show="validation.sprice.min&&validation.sprice.dirty">租金不能小于100</span>
	                <span v-show="validation.sprice.max&&validation.sprice.dirty">租金不能大于300000</span>
	            </div>
	            <div v-class="input_text_wrap:true, clearfix:true, error:validation.sprice.invalid&&validation.sprice.dirty,success:validation.sprice.valid" style="position: relative;">
	                <input type="inputText" style="width: 128px;" v-model="sprice" v-validate="required,numeric,min:100,max:300000"><span>{{priceType}}</span>
	            </div>
